...
public class HW_SwitchStatement {
    ...
    public static void main(String[] args) {
        ...
        switch(status){
            ...
            case 503: System.out.println("Service Unevailable"); break;
...
Given an int variable status, write a switch statement
that prints out, on a line by itself, the appropriate label
 from the above list based on status. Otherwise,
  print warning message: "Invalid status code!".
         */
    }
}
