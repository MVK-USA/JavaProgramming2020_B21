...
public class DateTimePractice {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=================================");
        DateTimeFormatter df = DateTimeFormatter.ofPattern("MM/dd, EEEE");
        ...
        for (int i = 0; i <= DofB.length - 1; i++) {
            ...
            System.out.println(older+" " +nameOfOlder +" is older");
        System.out.println("younger = " + younger +" "+ nameOfYoungest);
...
/*
 1. use the LocalDate & Time get the date and time in the following format:
    ...
    3. create an array of string and store 5 of your friend names
