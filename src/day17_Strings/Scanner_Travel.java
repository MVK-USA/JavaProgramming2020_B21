...
public class Scanner_Travel {
    public static void main(String[] args) {
        ...
        if (validPassport.equalsIgnoreCase("yes")) {
            ...
            System.out.println("How many people are travelling with");
            ...
            System.out.println("Your ticket is booked to "
                    + country + ". We have charged extra for the " + bags + " bags, but you are travelling with "
                    + namesOfPeople + " ,so we are giving a discount. Your total cost is: "
                    + cost);
            ...
            System.out.println("Looks like your password has been " +
                    "expired for " + expiredYears + ", but not " +
                    "to worry we will get it ready for you to " +
                    "travel to " + countries + ". Your total cost " +
        ...
        /*
         Travel
    - Make a cost variable to calculate how much the person
    ...
    - Ask the user if they have a valid password (boolean)
        > if the user enters true:
            ...
            Ask the user how many people they will travel with (short)
                > For each person the cost is reduced by 100.
                Up to a limit of 300.
            Ask the user to Enter the name of the people
            they will travel with in one line, separating
            each name with a comma (String, multiple word)
            Print: "Your ticket is booked to $countryName. W
            e have charged extra for the $numberOfBags bags
            but you are traveling with $peopleYouTravelWith
            so we are giving a discount. Your total cost
            is $costAmount"
        > if the user enters false:
            ...
            Ask the user which countries they plan to travel it,
            written in one line, separating each country with a comma
            Ask the user if they will be traveling in the next
            year (String - yes or no)
                > If yes: add 100 to the cost
                > If no: subtract 50 from the cost
            Print: "Looks like your password has been expired
            for $years, but not to worry we will get it ready
            for you to travel to $allCountries. Your total cost
