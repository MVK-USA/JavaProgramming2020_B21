...
public class HW_Scanner_027_SchoolGrades {
    public static void main(String[] args) {
        ...
        System.out.println("Your average score is: " + (grade1 + grade2
...
Declare 6 String variables: subject1,  subject2, subject3,
subject4, subject5, summary;
Declare 6 double variables: grade1,  grade2, grade3,
  grade4, grade5, average;
